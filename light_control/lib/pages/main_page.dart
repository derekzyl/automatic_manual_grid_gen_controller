...
import 'package:light_control/pages/b_col_task.dart';
import 'package:light_control/pages/chat_page.dart';
import 'package:light_control/pages/dis.dart';
import 'package:light_control/pages/sel_device.dart';
...
class _MainPage extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('light control app'),
      ),
      body: Container(
        child: ListView(
          children: <Widget>[
